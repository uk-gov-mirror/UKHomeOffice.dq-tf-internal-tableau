...
resource "aws_db_instance" "postgres" {
  ...
  allocated_storage               = var.environment == "prod" ? "5000" : "5000"
...
resource "aws_db_instance" "internal_reporting_snapshot_stg" {
  ...
  snapshot_identifier                 = var.environment == "prod" ? "rds:postgres-internal-tableau-apps-prod-dq-2026-07-15-00-05" : "rds:postgres-internal-tableau-apps-notprod-dq-2022-05-05-07-08"
  auto_minor_version_upgrade          = "false"
  backup_retention_period             = "14"
  copy_tags_to_snapshot               = "false"
  db_subnet_group_name                = aws_db_subnet_group.rds.id
